...
The `a2a-scanner` maintainers take all security issues in the project
seriously. Thank you for improving the security of `a2a-scanner`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`a2a-scanner` leverages GitHub's private vulnerability reporting.
