...
```json
{
  ...
  "false_positives": [
    {
      "_index": 2,
      "original_threat_name": "SUSPICIOUS AGENT ENDPOINT",
  ...
  "recommendations": [
    {
      "priority": "HIGH",
      "title": "Sanitize User Input in Agent Descriptions",
      "description": "Multiple injection vectors were found in agent description handling",
...
5. **Consider Context**: A finding's severity depends on how the agent is used
